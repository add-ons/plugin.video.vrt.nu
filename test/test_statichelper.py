...
class TestStaticHelper(unittest.TestCase):
    ...
    def test_url_to_program(self):
        ...
        self.assertEqual(program, statichelper.url_to_program(short_relevant_url))
    ...
    def test_shorten_link(self):
        ...
        self.assertEqual(permalink, statichelper.shorten_link(long_url))
        self.assertEqual(permalink, statichelper.shorten_link(medium_url))
