        ...
        if feature:
            ...
            if feature.startswith('jcr_'):
                ...
                if media.get('mediatype') == 'episodes':
                    ...
                    media_items, sort, _, content = self._apihelper.list_episodes(whatson_id=media.get('medialist'), variety=variety)
            ...
            show_listing(media_items, category=feature_msgctxt, sort=sort, content=content, cache=False)
        else:
