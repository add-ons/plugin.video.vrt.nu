...
@plugin.route('/programs/<program_name>/<list_id>')
@plugin.route('/programs/<program_name>/<list_id>/<end_cursor>')
def programs(program_name=None, list_id=None, end_cursor=''):
    """The Programs / Seasons / Episodes listing"""
    from vrtplayer import VRTPlayer
    if program_name:
        VRTPlayer().show_episodes_menu(program_name=program_name, list_id=list_id, end_cursor=end_cursor)
